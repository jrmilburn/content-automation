 ...
 * valid identifier. All three render identically and disclose nothing about the
 * post, so the page cannot be used to discover what exists elsewhere.
 */
