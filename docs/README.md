# Studio Parallel v1 planning documentation

Repository contributions follow the one-issue, one-dedicated-branch, one-pull-request workflow in [`CONTRIBUTING.md`](../CONTRIBUTING.md).

## Product and design

- [V1 product definition](product/v1-product-definition.md)
- [Terminology](product/terminology.md)
- [User journeys](product/user-journeys.md)
- [Design principles](design/design-principles.md)
- [Screen map](design/screen-map.md)
...
- [GitHub backlog import package](delivery/README.md)
- [Backlog overview](delivery/backlog-overview.md)
- [Backlog manifest](delivery/manifest.json)
